...
class PengajuanKenaikanPangkatController extends Controller
{
    ...
    {
        return view('dashboard.kasubang.kenaikan_pangkat.index', [
    ...
    {
        return view('dashboard.kasubang.kenaikan_pangkat.tambah', [
    ...
    public function store (KenaikanPangkatRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('kasubang.kenaikan-pangkat.index');
    }

    public function edit (KenaikanPangkat $kenaikanPangkat): View
    {
        return view('dashboard.kasubang.kenaikan_pangkat.ubah', [
