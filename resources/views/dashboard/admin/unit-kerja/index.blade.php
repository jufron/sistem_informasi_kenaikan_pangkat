<x-layouts.app judul="Unit Kerja">
  ...
  <div class="section-body">
    <div class="card">
      <div class="card-body">
        <x-button-link href="{{ route('admin.unit-kerja.create') }}" className="btn btn-primary my-4">
          Tambah
        </x-buttonLink>
        <x-table
          id="table_unit_kerja"
          ...
          <tr>
            ...
            <td>
              <form id="form_delete_unit-kerja" action="{{ route('admin.unit-kerja.delete', $uk) }}" method="POST">
                @method('delete')
                @csrf
