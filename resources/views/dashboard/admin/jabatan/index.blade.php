<x-layouts.app title="Jabatan">
  ...
  <div class="section-body">
    <div class="card">
      <div class="card-body">
        <x-button-link href="{{ route('admin.jabatan.create') }}" className="btn btn-primary my-4">
          Tambah
        </x-buttonLink>
        <x-table
          id="table_jabatan"
          ...
          <tr>
            ...
            <td>
              <form id="form_delete_jabatan" action="{{ route('admin.jabatan.delete', $jbtn) }}" method="POST">
                @method('delete')
                @csrf
