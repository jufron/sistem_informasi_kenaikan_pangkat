<x-layouts.app judul="Jabatan">
  ...
  <div class="section-body">
    <div class="card">
      <div class="card-body">
        <x-button-link href="{{ route('admin.golongan.create') }}" className="btn btn-primary my-4">
          Tambah
        </x-buttonLink>
        <x-table
          id="table_golongan"
          ...
          <tr>
            ...
            <td>
              <form id="form_delete_golongan" action="{{ route('admin.golongan.delete', $gol) }}" method="POST">
                @method('delete')
                @csrf
