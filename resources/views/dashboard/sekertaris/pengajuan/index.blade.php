    ...
    <div class="card">
      <div class="card-body">
        ...
        <x-table
          ...
          :head-label="['No', 'Nama Lengkap', 'Disetujui Kasubang', 'Disetujui Sekertaris', 'Pangkat Lama', 'Pangkat baru', 'Tggl dibuat', 'Tggl Perbaharui', 'action' ]"
          >
          ...
          <tr>
            ...
            <td>
              <x-button-link href="{{ route('sekertaris.pengajuan.edit', $kp) }}" className="btn btn-warning mx-1 my-1 btn-sm">
