<x-layouts.app judul="Ubah Kenaikan Pangkat">
  ...
  <div class="section-header">
    ...
    <div class="card">
      <div class="card-body">
        <form action="{{ route('pegawai.kenaikan-pangkat.update', $kenaikan_pangkat) }}" method="POST" enctype="multipart/form-data">
          @method('patch')
          @csrf
          <div class="row">
            ...
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->biodata_file)) }}">Download</x-button-link>
              @endif
            </div>
            ...
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sk_pangkat_terakhir_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sk_mutasi_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sk_pengangkatan_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->pembebasan_sementara_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->ijasah_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->surat_tanda_lulus_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->uraian_tugas_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sertifikat_ujian_dinas_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->penilaian_prestasi_kerja_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sasaran_kerja_pegawai_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->penilaian_capaian_sasaran_kerja_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->penilaian_perilaku_kerja_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sk_jabatan_atasan_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->kartu_pegawai_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->nip_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sk_cpns_file)) }}">Download</x-button-link>
              @endif
            </div>
            <div class="col-md-8 my-2">
              ...
              <x-button-link className="btn btn-success my-2 mx-2" href="{{ route('pegawai.kenaikan-pangkat.download', Crypt::encryptString($kenaikan_pangkat->sk_pns_file)) }}">Download</x-button-link>
              @endif
            </div>
            {{-- <div class="col-md-8">
          ...
          <x-button type-button="submit" class-name="btn btn-primary mt-3" modal="false">Perbaharui</x-button>
        </form>
      </div>
    </div>
  </div>
