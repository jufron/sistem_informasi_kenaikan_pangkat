<x-layouts.app judul="Pegawai">
  ...
  <div class="section-body">
    <div class="card">
      <div class="card-body">
        <x-button-link href="{{ route('kasubang.pegawai.create') }}" className="btn btn-primary my-4">
          Tambah
        </x-buttonLink>
        <x-table
          id="table_pegawai"
          ...
          <tr>
            ...
            <td class="d-flex" style="width: 130px">
              <form id="form_delete_pegawai" action="{{ route('kasubang.pegawai.delete', $peg) }}" method="POST" class="mx-1 my-1">
                @method('delete')
                @csrf
                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-show-pegawai" id="showPegawai" data-url="{{ route('kasubang.pegawai.show', $peg) }}">
