<x-layouts.app judul="Kenaikan Pangkat">
  ...
  <div class="section-body">
    <div class="card">
      <div class="card-body">
        <x-button-link href="{{ route('kasubang.kenaikan-pangkat.create') }}" className="btn btn-primary my-4">
          Ajukan
        </x-buttonLink>
        <x-table
          id="table_pegawai"
          :head-label="['No', 'Nama Lengkap', 'disetujui atasan', 'disetujui kasubang', 'Pangkat Lama', 'Pangkat baru', 'Tggl dibuat', 'Tggl Perbaharui', 'action' ]"
          >
          ...
          <tr>
            ...
            <td class="d-flex" style="width: 130px">
              <form id="form_delete_kenaikan_pangkat" action="{{ route('kasubang.kenaikan-pangkat.delete', $kp) }}" method="POST" class="mx-1 my-1">
                @method('delete')
                @csrf
                <x-button-link href="{{ route('kasubang.kenaikan-pangkat.edit', $kp) }}" className="btn btn-warning mx-1 my-1 btn-sm">
