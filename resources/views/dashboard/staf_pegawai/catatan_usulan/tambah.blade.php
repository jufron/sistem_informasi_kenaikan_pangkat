<x-layouts.app title="Tambah">
  ...
  <div class="section-header">
    <h1>Tambah Catatan Usulan</h1>
  </div>

    <div class="section-body">
    <div class="card">
      <div class="card-body">
        <form action="{{ route('staf_pegawai.catatan-usulan.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            <div class="col-md-6 mt-2 mb-4">
              <p class="my-1">File Catatan Usulan</p>
              <x-form-file2
                idInput="catatan_file_input"
                idLabel="catatan_file_label"
                name="catatan_usulan_file"
              />
            </div>
  ...
  <x-slot:scriptOptional>
    ...
    displayFileName('catatan_file_input', 'catatan_file_label');
    </script>
  </x-slot>
</x-layouts>
