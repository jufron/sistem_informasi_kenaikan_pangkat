<x-layouts.app judul="Catatan Usulan">
  ...
  <div class="section-body">
    <div class="card">
      <div class="card-body">
        <x-button-link href="{{ route('staf_pegawai.catatan-usulan.create') }}" className="btn btn-primary my-4">
          Tambah
        </x-buttonLink>
        <x-table
          id="table_golongan"
          ...
          <tr>
            ...
            <td>
                <x-button-link href="{{ route('staf_pegawai.catatan-usulan.download', $ctu) }}" className="btn btn-success mx-1 my-1 btn-sm">
            ...
            <td>
              <form id="form_delete_catatan_usulan" action="{{ route('staf_pegawai.catatan-usulan.delete', $ctu) }}" method="POST">
                @method('delete')
                @csrf
  ...
  <x-slot:scriptOptional>
    ...
    <script>
      ...
      const modals_delete_jabatan = document.querySelectorAll('#form_delete_catatan_usulan');
